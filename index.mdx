...
<CardGroup cols={2}>
  ...
  >
    Test your AdUnblock integration using our Chrome extension before going
    live.
  </Card>
  ...
  <Card
    title="General HTML/JS Integration"
    icon="code"
  ...
  <Card
    ...
    href="/guides/nextjs"
  >
    Advanced server-side integration for Node.js, PHP, and Python frameworks.
  </Card>
</CardGroup>

## Server-Side Integration

Advanced server-side packages for dynamic script loading with caching and security.
