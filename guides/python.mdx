...
```html
{% load server_tag_tags %} {% load custom_tags %}
...
<html>
  <head>
    <title>My Page</title>
    {% server_tag "https://config.adunblocker.com/server-tag.json"
    render_script=custom_script_renderer %}
  </head>
  <body>
    <h1>My Page</h1>
  </body>
...
<html>
  <head>
    <title>My Page</title>
    {% if user.is_authenticated %} {% server_tag
    "https://config.adunblocker.com/user-scripts.json" %} {% else %} {%
    server_tag "https://config.adunblocker.com/guest-scripts.json" %} {% endif
    %}
  </head>
  <body>
    <h1>My Page</h1>
...
```html
<!-- specific_page.html -->
{% extends "base.html" %} {% load server_tag_tags %} {% block extra_scripts %}
